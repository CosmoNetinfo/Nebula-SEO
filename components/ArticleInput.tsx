        ...
        <div className="flex flex-col gap-3 glass-card-intense p-5 rounded-xl shadow-xl relative slide-in-up border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-black/40 transition-colors duration-300">
            <div className="flex justify-between items-center pb-2 border-b border-zinc-100 dark:border-zinc-800">
                <div className="flex items-center gap-2">
                    ...
                    <h2 className="text-xs font-bold uppercase tracking-widest text-black dark:text-zinc-400">
                        New Article
                    </h2>
                </div>
                <div className="flex gap-2">
                     <button className="text-zinc-500 hover:text-black dark:text-zinc-600 dark:hover:text-white transition-all transform hover:scale-105" title="Backup to Cloud">
                        <CloudArrowDownIcon className="w-4 h-4" />
                    </button>
                    <button className="text-zinc-500 hover:text-black dark:text-zinc-600 dark:hover:text-white transition-all transform hover:scale-105" title="Import from Cloud">
            ...
            <div className="relative group">
                <textarea
                    ...
                    className="w-full h-48 p-4 bg-zinc-50 dark:bg-zinc-950/50 border border-zinc-200 dark:border-zinc-800 rounded-lg 
                             focus:ring-1 focus:ring-black dark:focus:ring-zinc-700 focus:border-black dark:focus:border-zinc-700 
                             focus:bg-white dark:focus:bg-zinc-950
                             transition-all duration-300 text-black dark:text-zinc-300 text-xs leading-relaxed 
            ...
            <button
                ...
                className="btn-primary flex items-center justify-center gap-2 w-full 
                         ...
                         relative overflow-hidden group text-[11px] tracking-widest uppercase border border-black dark:border-white"
            >
            ...
            <div className="flex justify-between items-center pt-2 px-1">
                <div className="flex gap-4 items-center">
                    <span className="text-[10px] text-black dark:text-zinc-400 font-bold tracking-tighter uppercase flex items-center gap-1.5">
                        <span className="w-1.5 h-1.5 rounded-full bg-black dark:bg-zinc-100 animate-pulse"></span>
                        Threads: 4
                    </span>
                    <span className="text-[10px] text-black dark:text-zinc-200 font-black tracking-tight uppercase bg-zinc-100 dark:bg-white/10 px-2 py-0.5 rounded border border-zinc-200 dark:border-white/10">
