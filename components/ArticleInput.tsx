...
export const ArticleInput: React.FC<ArticleInputProps> = ({ 
    ...
    return (
        <div className="flex flex-col gap-4 glass-card-intense p-6 rounded-2xl shadow-xl relative slide-in-up">
            <div className="flex justify-between items-center">
                <div className="flex items-center gap-2">
                    <div className="w-1.5 h-1.5 rounded-full bg-gradient-to-r from-indigo-400 to-cyan-400 animate-pulse"></div>
                    <h2 className="text-xs font-bold uppercase tracking-wider bg-gradient-to-r from-indigo-400 to-cyan-400 text-transparent bg-clip-text">
                        Nuovo Articolo
                    </h2>
                </div>
            ...
            <div className="relative group">
                <textarea
                    ...
                    className="w-full h-64 p-4 bg-slate-950/60 border border-slate-700/50 rounded-xl 
                    ...
                    disabled={isLoading}
                />
                <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-indigo-500/5 to-cyan-500/5 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none"></div>
            </div>
            ...
            <button
                ...
                className="btn-primary flex items-center justify-center gap-2.5 w-full 
                         ...
                         text-white font-bold py-4 px-5 rounded-xl 
            ...
            >
                ...
                <span className="relative z-10 tracking-wide">
                    {isLoading ? 'ELABORAZIONE...' : 'AGGIUNGI ALLA CODA BATCH'}
                </span>
            </button>
            
            <p className="text-[11px] text-slate-500/80 text-center font-medium flex items-center justify-center gap-2">
                <span className="w-1 h-1 rounded-full bg-slate-500/50"></span>
